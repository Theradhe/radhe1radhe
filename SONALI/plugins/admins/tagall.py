...
TAGMES = [ " **𝐇𝐞𝐲 𝐂𝐨𝐨𝐥 𝐀𝐧𝐠𝐞𝐥 𝐊𝐚𝐡𝐚 𝐇𝐨🤗🥱** ",
           ...
           " **𝐎𝐲𝐞 𝐆𝐨𝐨𝐝 𝐌𝐨𝐫𝐧𝐢𝐧𝐠😜** ",
           " **𝐒𝐮𝐬𝐡𝐫𝐞𝐞 𝐒𝐮𝐧𝐨 𝐄𝐤 𝐊𝐚𝐦 𝐇𝐚𝐢 𝐓𝐮𝐦𝐬𝐞🙂** ",
           " **𝐊𝐨𝐢 𝐒𝐨𝐧𝐠 𝐏𝐥𝐚𝐲 𝐊𝐫𝐨 𝐍𝐚😪** ",
           " **𝐍𝐢𝐜𝐞 𝐓𝐨 𝐌𝐞𝐞𝐭 𝐔𝐡☺** ",
           " **𝐇𝐞𝐥𝐥𝐨 🙊 𝐒𝐔𝐍𝐎 𝐀𝐁𝐇𝐀𝐘 𝐊𝐮𝐭𝐭𝐚 𝐡𝐚𝐢** ",
           " **𝐒𝐭𝐮𝐝𝐲 𝐂𝐨𝐦𝐥𝐞𝐭𝐞 𝐇𝐮𝐚 𝐃𝐨𝐜𝐭𝐨𝐫 𝐁𝐨𝐲??😺** ",
           " **𝐁𝐨𝐥𝐨 𝐍𝐚 𝐊𝐮𝐜𝐡 𝐓𝐈𝐖𝐀𝐑𝐈 𝐜𝐡𝐡𝐚𝐤𝐤𝐚🤭** ",
           " **𝐒𝐮𝐬𝐡𝐫𝐞𝐞 𝐊𝐨𝐧 𝐇𝐚𝐢...??😅** ",
           ...
           " **𝐊𝐚𝐡𝐚 𝐒𝐞 𝐇𝐨 𝐀𝐚𝐩😊** ",
           " **𝐒𝐮𝐧𝐨 𝐍𝐚 𝐒𝐔𝐒𝐇𝐑𝐄𝐄 𝐜𝐮𝐭𝐞 𝐡𝐚𝐢 𝐧🧐** ",
           " **𝐌𝐞𝐫𝐚 𝐄𝐤 𝐊𝐚𝐚𝐦 𝐊𝐚𝐫 𝐃𝐨𝐠𝐞..?** ",
           " **𝐁𝐲 𝐓𝐚𝐭𝐚 𝐌𝐚𝐭 𝐁𝐚𝐭 𝐊𝐚𝐫𝐧𝐚 𝐀𝐚𝐣 𝐊𝐞 𝐁𝐚𝐝😠** ",
           " **𝐌𝐨𝐦 𝐃𝐚𝐝 𝐊𝐚𝐢𝐬𝐞 𝐇𝐚𝐢𝐧..?❤** ",
           " **𝐊𝐲𝐚 𝐇𝐮𝐚 𝐚𝐛𝐡𝐚𝐲 (𝐑𝐚𝐝𝐡𝐞) 𝐤𝐨 𝐧𝐡𝐢 𝐣𝐚𝐧𝐭𝐞 𝐡𝐨..?👱** ",
           " **𝐁𝐨𝐡𝐨𝐭 𝐘𝐚𝐚𝐝 𝐀𝐚 𝐑𝐡𝐢 𝐇𝐚𝐢 𝐊𝐚𝐫𝐭𝐢𝐤 𝐦𝐞𝐫𝐞 𝐛𝐞𝐭𝐞 🤧❣️** ",
           " **𝐁𝐡𝐮𝐥 𝐆𝐲𝐞 𝐌𝐮𝐣𝐡𝐞 𝐛𝐞𝐭𝐞 😏😏** ",
           " **𝐉𝐮𝐭𝐡 𝐍𝐡𝐢 𝐁𝐨𝐥𝐧𝐚 𝐂𝐡𝐚𝐡𝐢𝐲𝐞 𝐣𝐮𝐧𝐢𝐨𝐫 🤐** ",
           " **𝐊𝐡𝐚 𝐋𝐨 𝐁𝐡𝐚𝐰 𝐌𝐚𝐭 𝐊𝐫𝐨 𝐁𝐚𝐚𝐭 𝐔𝐧𝐤𝐧𝐨𝐰𝐧😒** ",
           " **𝐊𝐲𝐚 𝐇𝐮𝐚😮😮 𝐓𝐈𝐖𝐀𝐑𝐈 𝐂𝐇𝐀𝐊𝐊𝐀 😁** ", 
           " **𝐓𝐈𝐖𝐀𝐑𝐈 𝐓𝐡𝐮𝐦𝐚𝐫𝐞 𝐩𝐚𝐩𝐚 𝐑𝐀𝐃𝐇𝐄 [ @ll_RADHE7_ll ] 𝐇𝐚𝐢 𝐧𝐚👀** ",
           " **𝐀𝐚𝐩𝐤𝐞 𝐉𝐚𝐢𝐬𝐚 𝐃𝐨𝐬𝐭 𝐇𝐨 𝐒𝐚𝐭𝐡 𝐌𝐞 𝐅𝐢𝐫 𝐆𝐮𝐦 𝐊𝐢𝐬 𝐁𝐚𝐭 𝐊𝐚 🙈** ",
           " **𝐀𝐚𝐣 𝐌𝐚𝐢 𝐒𝐚𝐝 𝐇𝐮 ☹️** ",
           " **𝐌𝐮𝐬𝐣𝐡𝐬𝐞 𝐁𝐡𝐢 𝐁𝐚𝐭 𝐊𝐚𝐫 𝐋𝐨 𝐍𝐚 🥺🥺** ",
           " **𝐊𝐲𝐚 𝐊𝐚𝐫 𝐑𝐚𝐡𝐞 𝐌𝐄𝐑𝐈 𝐆𝐔𝐆𝐔𝐋𝐘 👀** ",
           " **𝐊𝐲𝐚 𝐇𝐚𝐥 𝐂𝐡𝐚𝐥 𝐇𝐚𝐢 𝐑𝐀𝐃𝐇𝐄 𝐁𝐚𝐛𝐲🙂** ",
           " **𝐊𝐚𝐡𝐚 𝐒𝐞 𝐇𝐨 𝐀𝐚𝐩..?🤔** ",
           " **𝐂𝐡𝐚𝐭𝐭𝐢𝐧𝐠 𝐊𝐚𝐫 𝐋𝐨 𝐍𝐚..🥺** ",
           " **𝐌𝐞 [@ll_RADHE7_ll] 𝐌𝐚𝐬𝐨𝐨𝐦 𝐇𝐮 𝐍𝐚🥺🥺** ",
           " **𝐊𝐚𝐥 𝐌𝐚𝐣𝐚 𝐀𝐲𝐚 𝐓𝐡𝐚 𝐍𝐚 𝐛𝐚𝐛𝐲🤭😅** ",
           " **𝐉𝐮𝐧𝐢𝐨𝐫 𝐆𝐫𝐨𝐮𝐩 𝐌𝐞 𝐁𝐚𝐭 𝐊𝐲𝐮 𝐍𝐚𝐡𝐢 𝐊𝐚𝐫𝐭𝐢 𝐇𝐚𝐢😕** ",
           " **𝐀𝐚𝐩 𝐑𝐞𝐥𝐚𝐭𝐢𝐨𝐦𝐬𝐡𝐢𝐩 𝐌𝐞 𝐇𝐨..?👀** ",
           " **𝐒𝐔𝐒𝐇𝐑𝐄𝐄 𝐊𝐢𝐭𝐧𝐚 𝐂𝐡𝐮𝐩 𝐑𝐚𝐡𝐭𝐞 𝐇𝐨 𝐘𝐫𝐫😼** ",
...
async def cancel_spam(client, message):
    ...
    if not is_admin:
        ...
        try:
            ...
            pass
        return await message.reply("♦Rᴀᴅʜᴇ sᴛᴏᴘᴘᴇᴅ ᴛᴀɢɪɴɢ...♦")
